...
$conexion = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
                  ...
                  if ($resultado->num_rows > 0) {
                    while ($fila = $resultado->fetch_assoc()) {
                      echo "<tr>";
                      echo "<td>" . $fila["NumCuenta"] . "</td>";
                      echo "<td>" . $fila["NombreCuenta"] . "</td>";
                      echo "<td>" . $fila["Tipo"] . "</td>";
                      echo "<td>
                              <a href='actualizari.php?id=" . $fila["NumCuenta"] . "' class='btn btn-primary btn-sm'><i class='fas fa-edit'></i></a>
                              <a href='eliminar.php?id=" . $fila["NumCuenta"] . "' class='btn btn-danger btn-sm'><i class='fas fa-trash'></i></a>
                            </td>";
                      echo "</tr>";
                    }
                  } else {

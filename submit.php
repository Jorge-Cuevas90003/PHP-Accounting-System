...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['numCuenta']) && isset($_POST['nombreCuenta']) && isset($_POST['tipo'])) {
...
$conn = new mysqli(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME);
        ...
        $sqlCuentas = "INSERT INTO Cuentas (NumCuenta, NombreCuenta, Tipo) VALUES ('$numCuenta', '$nombreCuenta', '$tipo')";


        // Ejecutar las consultas SQL
        if ($conn->query($sqlCuentas) === TRUE ) {
           echo '<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="UTF-8">
...
';
        ...
        echo "Error: Algunos campos del formulario no están definidos";
    }
} else {
